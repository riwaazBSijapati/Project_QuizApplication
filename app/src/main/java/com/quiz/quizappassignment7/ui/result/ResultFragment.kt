...
import com.quiz.quizappassignment7.databinding.FragmentResultBinding
import com.quiz.quizappassignment7.viewModel.AnswerViewModel
import com.quiz.quizappassignment7.ui.SplashActivity
...
class ResultFragment : Fragment(R.layout.fragment_result), OnClickListener {
    ...
    private fun resetDB() {
        viewModel.resetDatabase(QuizQuestions.getQuizQuestions())
    }
}